...
const rocApi: RocPreloadApi = {
  ...
  tasks: {
    ...
    createBackgroundTask: (request) => ipcRenderer.invoke(ipcChannels.tasksCreateBackgroundTask, request),
  ...
  settings: {
    ...
    getHooks: () => ipcRenderer.invoke(ipcChannels.settingsHooksGet),
    saveHooks: (request) => ipcRenderer.invoke(ipcChannels.settingsHooksSave, request),
    trustHook: (request) => ipcRenderer.invoke(ipcChannels.settingsHooksTrust, request)
  },
  agent: {
    ...
    getLangSmithSettings: () => ipcRenderer.invoke(ipcChannels.agentLangSmithSettingsGet),
    saveLangSmithSettings: (config) => ipcRenderer.invoke(ipcChannels.agentLangSmithSettingsSave, config),
    setLangSmithApiKey: (request) => ipcRenderer.invoke(ipcChannels.agentLangSmithSecretSet, request),
    clearLangSmithApiKey: () => ipcRenderer.invoke(ipcChannels.agentLangSmithSecretClear)
  },
  chat: {
