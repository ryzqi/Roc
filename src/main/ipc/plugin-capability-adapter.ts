...
export const pluginCapabilityMappings = [
  ...
  mapping('agent', 'agent.getLangSmithSettings', ipcChannels.agentLangSmithSettingsGet, 'agent.langsmith.settings.get', emptyInput),
  mapping('agent', 'agent.saveLangSmithSettings', ipcChannels.agentLangSmithSettingsSave, 'agent.langsmith.settings.save', firstArg),
  mapping('agent', 'agent.setLangSmithApiKey', ipcChannels.agentLangSmithSecretSet, 'agent.langsmith.secret.set', firstArg),
  mapping('agent', 'agent.clearLangSmithApiKey', ipcChannels.agentLangSmithSecretClear, 'agent.langsmith.secret.clear', emptyInput),
