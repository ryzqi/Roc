...
function requiredMappings(): Array<{
  ...
  return [
    ...
    { preloadMethod: 'agent.getLangSmithSettings', capabilityName: 'agent.langsmith.settings.get', args: [], expectedInput: {} },
    { preloadMethod: 'agent.saveLangSmithSettings', capabilityName: 'agent.langsmith.settings.save', args: [request], expectedInput: request },
    { preloadMethod: 'agent.setLangSmithApiKey', capabilityName: 'agent.langsmith.secret.set', args: [request], expectedInput: request },
    { preloadMethod: 'agent.clearLangSmithApiKey', capabilityName: 'agent.langsmith.secret.clear', args: [], expectedInput: {} },
